...
[World Clock app](https://clock.mateuszdabrowski.pl) that helps you with Salesforce Marketing Cloud Engagement (MCE) system dates. Let the dashboard handle the timezone math so you can focus on building your automations.
...
[This dashboard](https://clock.mateuszdabrowski.pl) is a useful tool for everyone working in multiple timezones and developers planning to personalize communication using date data.
